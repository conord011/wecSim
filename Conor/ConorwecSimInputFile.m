...
simu.simMechanicsFile = 'Conor_RM3.slx';      % Specify Simulink Model File
...
% Floating (3DOF) Joint
constraint(1) = constraintClass('constraintClass.m'); % Initialize Constraint Class for Constraint1
